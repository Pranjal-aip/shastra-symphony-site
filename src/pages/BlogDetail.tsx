      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            {/* Full Content */}
            {(() => {
              const html = (post.content && t(post.content)) || '';
              const customHtml = (post.customHtml && t(post.customHtml)) || '';
              if (!html && !customHtml) return null;
              const isHtml = /<[a-z][\s\S]*>/i.test(html);
              const safeContent = isHtml ? sanitizeBlogHtml(html) : '';
              const safeCustom = customHtml ? sanitizeBlogHtml(customHtml) : '';
              ...
              return (
                <>
                  ...
                  {safeCustom && (
                    <div className={html ? "mt-8 pt-8 border-t" : ""} dangerouslySetInnerHTML={{ __html: safeCustom }} />
                  )}
                </>
              );
            })()}
